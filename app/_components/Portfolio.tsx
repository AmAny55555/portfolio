        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6 md:gap-8">
          ...
          {portfolioItems.map((item, index) => (
            <Card
              ...
              className="group overflow-hidden rounded-2xl border border-[#E5E7EB] bg-white p-0 shadow-[0_6px_20px_rgba(11,60,93,0.08)] hover:shadow-[0_14px_40px_rgba(11,60,93,0.15)] hover:-translate-y-1.5 transition-all duration-300"
            >
